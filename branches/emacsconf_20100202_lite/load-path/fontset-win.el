...
(defvar my-latin-font "Consolas")
(defvar my-chinese-font "Microsoft YaHei")
(defvar my-fontset "fontset-consolas")

(defvar my-latin-size 18)
(defvar my-chinese-size 18)
...
(create-fontset-from-fontset-spec
 "-outline-Lucida Sans Typewriter-normal-r-*-*-17-*-96-96-c-*-fontset-lucida")

(create-fontset-from-fontset-spec
 "-outline-DejaVu Sans Mono-normal-r-*-*-17-*-96-96-c-*-fontset-dejavu")

(create-fontset-from-fontset-spec
 "-outline-Consolas-normal-r-*-*-17-*-96-96-c-*-fontset-consolas")
...
(defun huangq-set-font (latin-size &optional chinese-size)
  ...
  (let ((latin-font
        ...
        (chinese-font
         (format
		  (concat "-outline-" my-chinese-font "-*-r-*-*-%d-*-96-96-*-*-gb2312.1980-0")
;;;           (if (string= my-chinese-font "微软雅黑")
;;; ;;           (decode-coding-string              
;;;               (concat "-outline-" my-chinese-font "-*-r-*-*-%d-*-96-96-p-*-gb2312.1980-0")
;;; ;;            'utf-8)
;;; ;;           (decode-coding-string              
;;;             (concat "-outline-" my-chinese-font "-*-r-*-*-%d-*-96-96-c-*-gb2312.1980-0")
;;; ;;            'utf-8)
;;;             )
          chinese-size)))
...
(global-set-key (kbd "C-x C-m s") 'huangq-set-font)
