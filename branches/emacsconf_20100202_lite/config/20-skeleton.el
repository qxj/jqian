...
;; 20-skeleton.el --- skeleton mode
;; Time-stamp: <2009-08-19 16:15:39 Julian_Qian>
...
;; hs-minor-mode, fold code
(dolist (hook (list 'c-mode-common-hook 'lisp-mode-hook 'emacs-lisp-mode-hook 'java-mode-hook)) (add-hook hook 'hs-minor-mode))
...
(defun hs-abstract-overlay (ov)
  (when (eq 'code (overlay-get ov 'hs))
    (overlay-put ov 'display
                 (propertize
                  (format "[This Block %d lines has been folded]" (count-lines (overlay-start ov) (overlay-end ov)))
                  'face 'my-yellow-red-face))))
