...
;; func-highlight.el --- keybind settings
;; Time-stamp: <Julian Qian 2010-08-16 15:55:52>

;; (require 'highlight-parentheses)

;; (setq hl-paren-colors '("red" "yellow" "cyan" "magenta" "green" "red"))

;; (dolist (hook (list 'find-file-hook 'help-mode-hook 'Man-mode-hook
;;                     'log-view-mode-hook
;;                     'compilation-mode-hook 'gdb-mode-hook
;;                     'lisp-interaction-mode-hook
;;                     'browse-kill-ring-mode-hook 'completion-list-mode-hook
;;                     'hs-hide-hook
;;                     'custom-mode-hook 'Info-mode-hook
